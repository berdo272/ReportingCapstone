...
namespace ReportingCapstone.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DepartmentName")] Department departments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DepartmentName")] Department departments)
        {
            if (ModelState.IsValid)
            {
